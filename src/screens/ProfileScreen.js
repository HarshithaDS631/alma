...
const COUNTRY_CODES = [
  ...
  { code: '+44', country: 'United Kingdom', flag: '🇬🇧', short: 'UK' },
  { code: '+971', country: 'United Arab Emirates', flag: '🇦🇪', short: 'UAE' },
  ...
  { code: '+41', country: 'Switzerland', flag: '🇨🇭', short: 'CH' },
  { code: '+31', country: 'Netherlands', flag: '🇳🇱', short: 'NL' },
  { code: '+46', country: 'Sweden', flag: '🇸🇪', short: 'SE' },
  ...
  { code: '+39', country: 'Italy', flag: '🇮🇹', short: 'IT' },
  { code: '+34', country: 'Spain', flag: '🇪🇸', short: 'ES' },
...
const DEFAULT_TAGGED_POSTS = [];
  ...
  const handleSaveContactInfo = async () => {
    ...
    try {
      ...
      const cleanCode = editCountryCode || '+91';
      await updateProfile({
        phone: cleanPhone,
      ...
      if (cachedStr) {
        ...
        cached.phone = cleanPhone;
        cached.countryCode = cleanCode;
          ...
          <View style={[styles.modalContent, { maxWidth: 440, paddingBottom: 24, zIndex: 10 }]}>
            ...
            <View style={{ padding: 18 }}>
              ...
              <View style={{ flexDirection: 'row', alignItems: 'center', gap: 8 }}>
                ...
                >
                  <Text style={{ fontSize: 14, fontWeight: '700', color: theme.text }}>
                    {editCountryCode} ({COUNTRY_CODES.find(c => c.code === editCountryCode)?.short || 'IN'})
                  </Text>
                  <Ionicons name="chevron-down" size={16} color="#64748B" />
                </TouchableOpacity>
...
const getStyles = (theme) => StyleSheet.create({
  ...
  statBox: {
    ...
    paddingHorizontal: 4,
    borderRadius: 14,
    backgroundColor: theme.surfaceDepressed || theme.cardSecondary,
    borderWidth: 1.5,
  ...
  actionButton: {
    flex: 1,
    backgroundColor: theme.surfaceDepressed || theme.cardSecondary || '#F1F5F9',
    borderWidth: 1.5,
    borderColor: theme.cardBorder || theme.border,
    height: 42,
    borderRadius: 12,
  ...
  smallIconBtn: {
    backgroundColor: theme.cardSecondary || '#FEF2F2',
    borderWidth: 1,
    borderColor: theme.border,
    width: 40,
    height: 40,
