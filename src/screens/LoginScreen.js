...
const LoginScreen = ({ navigation }) => {
  ...
  const executeAutoLogin = async (role = 'alumni') => {
    try {
      if (role === 'admin') {
    ...
    <SafeAreaView style={styles.container}>
      ...
      >
        <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
          ...
          {/* Quick Auto Login for Manager Demo / Direct Access */}
          <View style={{
            ...
            <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: 8 }}>
              <Ionicons name="flash" size={16} color="#0284C7" style={{ marginRight: 6 }} />
              <Text style={{ fontSize: 12, fontWeight: '800', color: '#0284C7', letterSpacing: 0.5, textTransform: 'uppercase' }}>
            ...
            <TouchableOpacity
              ...
              onPress={() => executeAutoLogin('alumni')}
              activeOpacity={0.85}
            >
              <Ionicons name="person-circle" size={18} color="#FFFFFF" style={{ marginRight: 8 }} />
              <Text style={{ color: '#FFFFFF', fontWeight: '700', fontSize: 14 }}>
                Auto Login as Alumni (Harshitha D S)
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              onPress={() => executeAutoLogin('admin')}
              activeOpacity={0.85}
            >
              <Ionicons name="shield-checkmark" size={16} color="#0284C7" style={{ marginRight: 8 }} />
              <Text style={{ color: '#0284C7', fontWeight: '700', fontSize: 13 }}>
                Auto Login as RVCE Admin
              </Text>
            </TouchableOpacity>
          </View>
